...
| MMU / full-system 32-bit | Kernel Linux ARMv6/v7 | 🟡 épico B4.1 quase completo (B4.1.1-B4.1.4 ✅: `TranslatingAddressSpace`/`Cp15VmsaCoprocessor`/aborts precisos com FAR/FSR nos 3 motores) — `virtual-arm-box` (B4.1.5 🟡 parcial) roda hospedeiro versatilepb com kernel Debian real + busybox-armv5l até a descompressão do zImage, mas trava num `PREFETCH_ABORT` recursivo perto da página de vetores altos antes de alcançar shell; ver [RFC-SOFTMMU](docs/RFC-SOFTMMU.md) |
