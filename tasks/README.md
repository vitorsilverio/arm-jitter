...
| [B2.2](trilha-b-arquiteturas/b2.2-thumb2-dataproc.md) | Data-processing 32-bit (modified immediate, MOVW/MOVT, shifts) | B2.1 | ⬜ |
...
| [C1](trilha-c-perf/c1-flags-nzcv-locals.md) | Flags NZCV em locals JVM (⚠️ prioridade rebaixada) | — | ❌ FECHADA SEM IMPLEMENTAR (2026-07-11) — a própria task instrui "só execute isolada com A/B bench provando ganho; sem ganho medido, feche com o resultado negativo registrado". O re-profile de 2026-07-08 (já citado na task) mostrou que os helpers de flags e os guards de condição NÃO aparecem nas folhas quentes de gameplay (MKDS corrida) — ganho esperado ≈0. É a task de MAIOR RISCO de corretude da trilha C (lista de invariantes de flush/reload "que não pode falhar"). Sem evidência de ganho e com risco alto, não compensa o custo-benefício agora; reabrir só se REPRIORIZADA no contexto de C0 (superblocos), onde flags em locals atravessando fronteiras de bloco fazem mais sentido |
