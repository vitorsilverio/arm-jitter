...
| P13.5 | **G4.1** — `APT:GetSharedFont` (fonte do sistema para o console) | `trilha-g-3ds/g4.1-apt-shared-font.md` | n3dsemu | G4 | achado ao tentar validar visualmente a G4 (ver nota abaixo, sessão 2026-08-19): sem fonte mapeada, o console nunca desenha glyph nenhum — tela fica preta mesmo com framebuffer trocando certo |
