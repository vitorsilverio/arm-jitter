...
| (sem task, NOVA 2026-07-18) Platinum Continue = "communication error/Union Room" + tela branca (save ÍNTEGRO no disco, CRCs ok; ARM9 eterno em OS_WaitIrq(VBLANK) após o A; repro headless ContinueProbe — probes precisam carregar o .sav via cartridgeBackup().load) | ndsemu | ⚠️ MODELO FORTE |
