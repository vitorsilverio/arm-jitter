...
cruzado pela B8.5 acima — global 53%→59% desde o `1.0.0`) seguindo o procedimento da `F5`
(`trilha-f-infra/f5-maven-central-publicacao.md`), depois **F7** nos 4 consumidores. Não pego
automaticamente por ser publicação externa/irreversível.
