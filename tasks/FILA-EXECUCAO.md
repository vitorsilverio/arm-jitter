...
| 6b | ~~D2~~ ✅ FECHADA 2026-07-16 — hipótese 1 (HDMA em V-Blank) corrigida; hipótese 2 (wrap OAM) REFUTADA (era artefato do bug 1, validado em jogo real); hipótese 3 (OBJ window) corrigida. Falta só validação visual do usuário no golpe de status | — | — | — |
