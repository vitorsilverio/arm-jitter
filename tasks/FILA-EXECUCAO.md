...
| **C8** (perf interpretador) | C6 | Fase 1 ✅ 2026-07-17; fase 2 candidato #1 (dispatch) ✅ 2026-07-17, −15,6% agregado (ver `tasks/README.md`) — próxima sessão: candidato #2 (decode/lift) ou parar |
