...
| (sem task, NOVA 2026-07-18) Platinum GAMEPLAY: personagem em "faixas pretas"/invisível no quarto — chars = billboards 3D com textura streamada por flip de banco; fix do snapshot-por-evento shipped (ndsemu `6f72757`, 🧑 validação pendente); se não bastar: upload dos billboards nunca ocorre no drive headless (fatos e ferramentas na memória `ndsemu-game-compat`) | ndsemu | ⚠️ MODELO FORTE |
