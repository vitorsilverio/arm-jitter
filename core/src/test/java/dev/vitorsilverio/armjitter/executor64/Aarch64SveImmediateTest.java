...
class Aarch64SveImmediateTest {
    ...
    void anSveClassWordWithAnUnknownPrefixIsRefused() {
        assertTrue(refused(0x26000000), "prefixo 0x26 está na classe SVE mas não é de nenhum grupo");
    }
    ...
    void otherPatternsOfTheSamePrefixStayForOtherGroups() {
        ...
        assertTrue(refused(0x05388020), "prefixo 0x05: bits[21:16] = 111000 não é de nenhum grupo (a B17.11 fechou os vizinhos)");
    }
