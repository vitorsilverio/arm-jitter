...
> **98%** — 23484 de 23783 células aplicáveis decodificam.
...
| MPCore | **100%** (356/356) |
| v7-A | **100%** (652/652) |
| v7-A+NEON | **93%** (944/1012) |
| v7-R | **90%** (594/659) |
| v8-R | **96%** (637/661) |
| v8-A/32 | **96%** (749/776) |
| v8.6-A/32 | **96%** (751/778) |
| v6-M | **100%** (94/94) |
| v7-M | **100%** (334/334) |
| ARMv8.1-M+MVE | **93%** (694/742) |
...
|---|---:|---|
| A32 — instruções ARM de 32 bits | 266 | v4T 100% (144/144) · v5TE 100% (156/156) · v6K 100% (231/231) · MPCore 100% (231/231) · v7-A 100% (244/244) · v7-A+NEON 94% (251/265) · v7-R 92% (246/265) · v8-R 99% (265/266) · v8-A/32 100% (266/266) · v8.6-A/32 100% (266/266) |
| T16 — Thumb clássico | 87 | v4T 100% (62/62) · v5TE 100% (65/65) · v6K 100% (75/75) · MPCore 100% (75/75) · v7-A 100% (82/82) · v7-A+NEON 98% (83/84) · v7-R 98% (83/84) · v8-R 98% (84/85) · v6-M 100% (75/75) · v7-M 100% (81/81) · ARMv8.1-M+MVE 100% (83/83) · v8-A/32 98% (84/85) · v8.6-A/32 98% (84/85) |
| T32 — Thumb-2 | 310 | v7-A 100% (268/268) · v7-A+NEON 86% (269/310) · v7-R 85% (265/310) · v8-R 92% (288/310) · v6-M 100% (8/8) · v7-M 100% (242/242) · ARMv8.1-M+MVE 83% (248/296) · v8-A/32 93% (289/310) · v8.6-A/32 93% (289/310) |
| VFP — ponto flutuante (condicional) | 101 | MPCore 100% (50/50) · v7-A 100% (58/58) · v7-A+NEON 92% (58/63) · v8-A/32 94% (93/98) · v8.6-A/32 95% (95/100) |
| VFP — formas incondicionais (ARMv8-A) | 17 | v8-A/32 100% (17/17) · v8.6-A/32 100% (17/17) |
...
| Instrução | v4T | v5TE | v6K | MPCore | v7-A | v7-A+NEON | v7-R | v8-R | v6-M | v7-M | ARMv8.1-M+MVE | v8-A/32 | v8.6-A/32 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|---|
| `AND_rrri` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | · | · | · | ✅ | ✅ |
| `EOR_rrri` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | · | · | · | ✅ | ✅ |
| `SUB_rrri` | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | ✅ | · | · | · | ✅ | ✅ |
...
`VSEL`/`VMAXNM`/`VMINNM`/`VRINT`/`VCVTA` são ARMv8-A de 32 bits — aplicável a partir de `ArmArchitecture.ARMV8A_32` (B14.7).
...
Advanced SIMD: extensão OPCIONAL do ARMv7-A — aplicável a partir de `ArmArchitecture.ARMV7A_NEON` (B13.22). As formas de features irmãs (RDM/cripto/FCMA/DotProd/I8MM/FHM/BF16, nenhuma delas em núcleos ARMv7-A reais) são curadas à parte, ver `ARM32_VERSION_REQUIREMENTS`.
...
Aplicável a partir de `ArmArchitecture.ARMV7A_NEON` (B13.22); todas as 23 linhas exigem uma feature irmã além de `ADVANCED_SIMD` — ver `ARM32_VERSION_REQUIREMENTS`.
