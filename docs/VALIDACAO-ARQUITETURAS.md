...
> resíduo de B22; VFP incondicional ARMv8-A (**B14**) e NEON/SVE/SME (**B13**/**B17**/**B18**)
> nem entram no denominador (`NOT_IN_ANY_PRESET`) — **MVE (Helium) é exceção desde a B16.14**:
> tem coluna própria (`ARMv8.1-M+MVE`) e mede **352/352** no grupo `mve.decode`, 95% (693/727)
> contando os grupos T16/T32/VFP/`m-nocp` que a coluna nova também passou a medir; e o A64
